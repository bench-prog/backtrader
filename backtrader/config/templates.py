...
class EnvironmentTemplates:
    ...
    def get_testing_template() -> Dict[str, Any]:
        """测试环境模板"""
        return {
            "environment": {"name": "testing", "debug": True, "log_level": "INFO"},
            "database": {
    ...
    def get_staging_template() -> Dict[str, Any]:
        """预发布环境模板"""
        return {
            "environment": {"name": "staging", "debug": False, "log_level": "WARNING"},
            "database": {
    ...
    def get_production_template() -> Dict[str, Any]:
        """生产环境模板"""
        return {
            "environment": {"name": "production", "debug": False, "log_level": "ERROR"},
            "database": {
        ...
        if "database" in config:
            ...
            env_vars.extend(
                [
                    ...
                    "DB_PASSWORD=your_password_here",  # 密码需要手动设置
                ]
            )
