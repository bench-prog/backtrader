...
class CandlestickPlotHandler(object):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if tickup:
            r, g, b = mcolors.to_rgb(tickup)
            self.tickup = ((r, g, b, alpha),)
        else:
            self.tickup = self.edgeup

        if tickdown:
            r, g, b = mcolors.to_rgb(tickdown)
